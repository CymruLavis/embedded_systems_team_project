...
#define SWITCH1_PIN 22 // GPIO pin for switch 1
#define SWITCH2_PIN 27 // GPIO pin for switch 2
#define Red_LED 5    // GPIO pin for LED 1
#define Green_LED 6    // GPIO pin for LED 2
